...
public:
    ...
    Material             material; //一个mesh对应一个材质  

    vector<Triangle>     triangles;//场景上所有三角形，便于检测光追
    ...
    {
        this->myShader = (Shader*)malloc(sizeof(Shader));
        std::cout << "顶点个数   " << vertices.size() << "    三角形个数" << triangles.size() << endl;
        this->vertices = vertices;
        this->indices = indices;
        this->textures = textures;
        ...
        //std::cout << "buildBVHwithSAH结束  " << endl;
